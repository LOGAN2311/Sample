...
class MoviesList extends React.Component{
    ...
    render(){
        ...
        if(this.state.movies.length===0){
            element = <p>No datas to show</p>
        }else{
            element = <p>The Number of Movies from database - {this.state.movies.length}</p>
        }
        let table;
        if(this.state.movies.length===0){
            table = ' '
    ...
    return(
        <div>    
            ...
            {this.state.movies.map(movie => ( <Movies key={movie.id} 
                                                      id={movie.id}  
                                                      title={movie.title} 
                                                      year={movie.year} 
